...
class AllotOrderProducts extends Migrator {
    /**
     * Change Method.
     *
    ...
    public function change () {
        $table = $this->table('allot_order_products', array('engine' => 'Innodb'));
        $table->addColumn('allot_order_id', 'integer', array(
            'limit' => 10, 'default' => 0, 'comment' => '调拨单id'
        ))

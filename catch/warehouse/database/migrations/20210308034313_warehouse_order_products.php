...
class WarehouseOrderProducts extends Migrator {
    /**
     * Change Method.
     *
    ...
    public function change () {
        $table = $this->table('warehouse_order_products', array('engine' => 'Innodb'));
        $table->addColumn('warehouse_order_id', 'integer', array(
            'limit' => 10, 'default' => 0, 'comment' => '入库单id'
        ))
              ...
              ->addColumn('number', 'integer', array(
                  'limit' => '10', 'default' => 0, 'comment' => '入库数量'
              ))

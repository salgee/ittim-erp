...
class InstallProjectCommand extends Command
{
    ...
    protected $defaultModule = ['basics', 'permissions', 'system', 'delivery', 'finance', 'order', 'product',
        'report', 'settlement', 'store', 'supply', 'warehouse'];
    ...
    protected function detectionEnvironment(): void
    {
        ...
        if (!extension_loaded('redis')) {
            $this->output->error('redis extension not install');
            exit();
        }
        $this->output->info('redis extension is installed');
